...
<html>
    <head>
        ...
        <meta name = "title" content = "Layout Software - Donate">

        <link rel = "stylesheet" href = "../assets/styles/home-styles.css">
        <link rel = "stylesheet" href = "../assets/styles/donate-styles.css">
        ...
        <script src = "../assets/scripts/donate-functions.js"></script>
