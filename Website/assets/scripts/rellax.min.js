(function(q,g) {
    ...
    try {
        ...
        var k=Object.defineProperty({},"passive",{get:function(){x=!0}});window.addEventListener("testPassive",null,k);
    ...
    if(0<k.length) {
        ...
        var F, B=function() {
            ...
            for(f=0;f<a.elems.length;f++) {
                ...
                z=e?e:(z-t+v)/(g+v);e=e?e:(I-h+n)/(k+n);
            ...
            return d!=l&&a.options.vertical || c!=m&&a.options.horizontal?!0:!1}, J=function(d,c,b,e,g) {
                
                var f={};
                d=100*(g?g:b)*(1-d);c=100*(e?e:b)*(1-c);
                ...
                H()&&!1===w?(K(),
                p=A(G)):(p=null,window.addEventListener("resize",h),
